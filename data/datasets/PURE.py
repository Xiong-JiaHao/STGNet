...
class PURE(VisionDataset):
    ...
    def load_data(self):
        ...
        if self.fps == 30:
            ...
            meta = pd.read_csv('data/datasets/metadata/PURE_90fps.csv')
        else:
    ...
    def apply_transformations(self, clip, subj, idcs, augment=True):
        ...
        if augment:
            ...
            if self.aug_speed:
                ...
                clip, idcs, speed = transforms.augment_speed(entire_clip, idcs, self.frames_per_clip, self.channels,
                                                             self.speed_slow, self.speed_fast)
